# Big Data WordCount Benchmark (Hadoop MapReduce vs. PySpark)
...
Download the ~100 MB sample text file used for this benchmark:

* **Download link:** [https://examplefile.com/text/txt/100-mb-txt](https://examplefile.com/text/txt/100-mb-txt)

Save the downloaded file locally as `examplefile-100mb.txt`, then ensure your input directory exists in HDFS, upload the file, and clear any old output paths:
